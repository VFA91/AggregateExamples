namespace Kernel.Library.Shared
{
    ...
    public abstract class Specification<T>
    {
        ...
        {
            Func<T, bool> predicate = SatisfiedBy().Compile();
    ...
    public class AndSpecification<T> : Specification<T>
    {
        ...
        {
            Expression<Func<T, bool>> leftExpression = _left.SatisfiedBy();
            Expression<Func<T, bool>> rightExpression = _right.SatisfiedBy();
